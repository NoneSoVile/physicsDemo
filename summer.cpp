...
public:
	...
	void processCollision(int vertexIndex) {
...
public:
	...
	void init(vec4f translatePos, float angle) {
...
public:
	...
	void findIntersection(LineSegment*, triangle*) {

	}

	bool testIntersection(LineSegment*, triangle*) {
		return false;
	}
};
